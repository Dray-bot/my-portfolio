      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-[3.5rem] left-0 w-full max-h-[calc(100vh-3.5rem)] bg-white dark:bg-[#111] text-gray-900 dark:text-white rounded-t-2xl z-[999] md:hidden overflow-auto"
          >
