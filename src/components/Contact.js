...
const Contact = () => {
  return (
    <section
      id="contact"
      className="bg-grey-900 px-6 py-20 text-white font-inter"
    >
        ...
        <div className="grid gap-6 sm:grid-cols-2 mt-10">
          {contactLinks.map(({ label, href, icon: Icon }, index) => (
            <motion.a
              ...
              className="flex items-center gap-4 px-6 py-4 bg-white hover:bg-emerald-50 transition rounded-xl shadow text-[#1f2937] font-medium"
            >
